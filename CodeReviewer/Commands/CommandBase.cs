...
///     Provides a default implementation for the <see cref="CanExecute" /> method and an event for when the command's
...
public abstract class CommandBase : ICommand {
    ...
    ///     Data used by the command to determine if it can execute. This parameter is optional and can be
    ///     <c>null</c>.
    /// </param>
    ...
    /// <summary>
    ///     Raises the <see cref="CanExecuteChanged" /> event to indicate that the command's ability to execute may have
    ///     changed.
    /// </summary>
